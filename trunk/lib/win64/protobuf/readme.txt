...
This package contains a precompiled Win64 binary version of the protocol buffer
...
This binary was built using MSVC2008 but the output is the same regardless of
the C++ compiler used.
